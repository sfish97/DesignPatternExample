...
public class SolarEclipseBattle implements Battles {
     ...
     * 
     */
    public SolarEclipseBattle() {}
    
    /** The Hero and Villain fight during a Solar Eclipse.
     * 
     * @param hero      The hero
     * @param villain   The villain
     */
    public SolarEclipseBattle(Person hero, Person villain) {       
     ...
     *  For every power they have, only 1 point gets added to their level.
     * 
    ...
    public int getAttackersLevel(Person attacker) {
        ...
        for (PowerInfo iter : attacker.getPowersInfo()) {
            ...
            if (powerName.equals("Water")) {             //Double the Water Level
                ...
                level += 1;
            } else if (powerName.equals("Lava")) {         //2 points for having Lava Power
                level += 1;
